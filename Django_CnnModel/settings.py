"""
Django settings for Django_CnnModel project.
...
INSTALLED_APPS = [
    ...
    'cnn_model_api', # Add your new app here
    # Add Django REST Framework for API if you plan to use it more extensively
    'rest_framework',
    'corsheaders', # Needed for handling CORS with your React app
]
...
WSGI_APPLICATION = 'Django_CnnModel.wsgi.application'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'cnn_model_api': { # Logger for your specific app
            'handlers': ['console'],
            'level': 'INFO',
            'propagate': False,
        },
